          ...
          <div className={`transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="text-center mb-10">
              ...
              <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-8">
                Search for up-to-date performance data and insights for any product
              </p>
              {/* Search Bar */}
            ...
            <div className={`mt-16 text-center transition-all duration-700 delay-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-2xl font-bold text-white mb-4">Ready to analyze product performance?</h2>
